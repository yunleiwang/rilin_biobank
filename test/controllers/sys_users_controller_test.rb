...
class SysUsersControllerTest < ActionController::TestCase
  ...
  test "should create sys_user" do
    assert_difference('SysUser.count') do
      post :create, sys_user: { birthday: @sys_user.birthday, department_id: @sys_user.department_id, gender: @sys_user.gender, password: @sys_user.password, role_id: @sys_user.role_id, username: @sys_user.username }
    end
  ...
  test "should update sys_user" do
    patch :update, id: @sys_user, sys_user: { birthday: @sys_user.birthday, department_id: @sys_user.department_id, gender: @sys_user.gender, password: @sys_user.password, role_id: @sys_user.role_id, username: @sys_user.username }
    assert_redirected_to sys_user_path(assigns(:sys_user))
  end
